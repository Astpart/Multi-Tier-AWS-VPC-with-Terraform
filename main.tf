...
# Database Subnets (Data tier) - NO NAT, COMPLETELY FREE
resource "aws_subnet" "database_subnet" {
  ...
  tags = {
    Name        = "${var.environment}-${element(local.availability_zones, count.index)}-database-subnet"
    Environment = var.environment
    Tier        = "data"
  }
}

# Private Route Table (no internet access - FREE)
